<template>
    <div class="autocomplete">
        <input class='form-control' type="text" :placeholder="placeholder" @focus="onFocus" @input="onChange"
            v-model="search" @keydown.down="onArrowDown" @keydown.up="onArrowUp" @keydown.enter="onEnter"
            @keydown.tab="onEnter" :required="isRequired" />
...
<script>
    export default {
        ...
        methods: {
            ...
            onArrowDown(evt) { // eslint-disable-line
        ...
        watch: {
            items: function (val, oldValue) { // eslint-disable-line
            ...
            initialDisplay: function (val, oldValue) { // eslint-disable-line
                if (val !== oldValue) {
                    this.search = val;
                }
            }
